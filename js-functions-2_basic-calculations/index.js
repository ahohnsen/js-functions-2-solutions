...
console.assert(add(1, 1) === 2, `add(1,1) should be 2, instead got ${add(1, 1)}`);
console.assert(add(12, 192) === 204, `add(12,192) should be 204, instead got ${add(12, 192)}`);
console.assert(
  add(-1020, 5843) === 4823,
  `add(-1020, 5843) should be 4823, instead got ${add(-1020, 5843)}`
);

console.assert(subtract(1, 1) === 0, `subtract(1,1) should be 0, instead got ${subtract(1, 1)}`);
console.assert(
  subtract(12, 192) === -180,
...
console.assert(multiply(1, 1) === 1, `multiply(1,1) should be 1, instead got ${multiply(1, 1)}`);
console.assert(
...
console.assert(
  ...
  `multiply(-1020, 5843) should be  -5959860, instead got ${multiply(-1020, 5843)}`
);

console.assert(divide(1, 1) === 1, `divide(1,1) should be 1, instead got ${divide(1, 1)}`);
console.assert(
...
console.assert(
  ...
  `divide(-1020, 5843) should be  -0.17456785897655314, instead got ${divide(-1020, 5843)}`
);

console.assert(remainder(1, 2) === 1, `remainder(1,2) should be 1, instead got ${remainder(1, 2)}`);
console.assert(
  remainder(67, 24) === 19,
